import { Maze, Cell, CellType, Point, createCell } from '../core/Maze.js';
...
export class MazeGenerator {
    ...
    constructor(width: number = 31, height: number = 31) {
        // 确保奇数尺寸
    ...
    private getUnvisitedNeighbors(p: Point): Point[] {
    ...
    private findFarthestPoint(start: Point): Point {
