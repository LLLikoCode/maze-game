...
export class EventSystem {
    ...
    private checkCondition(condition: string, playerState: Record<string, any>): boolean {
        // 简化条件检查
    ...
    // 处理玩家选择
    processChoice(eventId: string, choiceId: string): { success: boolean; message: string; rewards?: string[]; risks?: string[] } {
