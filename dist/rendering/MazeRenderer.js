...
export class MazeRenderer {
    constructor(canvas, cellSize = 16) {
    ...
    drawPlayer(px, py) {
        ...
        // 玩家光晕
        const gradient = this.ctx.createRadialGradient(centerX, centerY, 0, centerX, centerY, this.cellSize * 1.5);
...
//# sourceMappingURL=MazeRenderer.js.map