    ...
    drawDrawnCell(cell) {
        ...
        switch (cell.type) {
            case CellType.WALL:
                ...
                this.ctx.fillRect(px + jitter(), py + jitter(), this.cellSize - 2, this.cellSize - 2);
                break;
            case CellType.PATH:
                // 绘制通道（小点）
                this.ctx.fillStyle = '#666';
                this.ctx.fillRect(px + this.cellSize / 3, py + this.cellSize / 3, this.cellSize / 3, this.cellSize / 3);
                break;
